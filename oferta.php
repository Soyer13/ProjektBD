...
<body>
    ...
    $sql  = "SELECT products.id AS 'prod_id', products.name, products.prod_cat_id, products.price, products.quantity, products.description, products.image_url, users.login FROM products, users WHERE products.id = $idP AND products.users_id = users.id AND products.if_sold = 'n'";
    ...
    <main>
        ...
        ?>
            ...
            <div id="Oferta-Main">
                <div id="obrazek">
                    <img src="images/prod/<?php echo $row['image_url'] ?>" alt="zdjęcie" height="600px">
                </div>
                <div id="Panel-Oferty">
